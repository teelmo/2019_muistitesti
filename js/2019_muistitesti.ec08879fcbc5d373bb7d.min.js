...
function App() {
  ...
  var _useState21 = (0,react.useState)('Paina mieleesi ruudulla näkyvät sanat. Kun aika on loppu, kirjoita sanat ruudulle ilmestyviin laatikoihin. Halutessasi saat vastauslaatikot näkyviin heti painamalla sekuntikellon kuvaa.'),
  ...
  var getDataPath = function getDataPath() {
    ...
    if (true) return 'https://lusi-dataviz.ylestatic.fi/2019_muistitesti/assets/data';
    return 'assets/data';
  };
  (0,react.useEffect)(function () {
    fetch("".concat(getDataPath(), "/2019_muistitesti_data.json")).then(function (response) {
      if (!response.ok) {
      ...
      setData(index_default.shuffle(body.data));
    });
  }, []);
  ...
  return /*#__PURE__*/react.createElement("div", {
    className: "app"
  }, /*#__PURE__*/react.createElement("h2", null, "Muistipeli"), /*#__PURE__*/react.createElement("div", {
