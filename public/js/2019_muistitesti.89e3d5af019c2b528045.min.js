...
function App() {
  ...
  var _useState3 = (0,react.useState)([]),
    ...
    dataAll = _useState4[0],
    setDataAll = _useState4[1];
  var _useState5 = (0,react.useState)(''),
    _useState6 = _slicedToArray(_useState5, 2),
    facebookLink = _useState6[0],
    setFacebookLink = _useState6[1];
  var _useState7 = (0,react.useState)(false),
    _useState8 = _slicedToArray(_useState7, 2),
    hiddenInfo = _useState8[0],
    setHiddenInfo = _useState8[1];
  var _useState9 = (0,react.useState)(true),
    _useState10 = _slicedToArray(_useState9, 2),
    hiddenInput = _useState10[0],
    setHiddenInput = _useState10[1];
  var _useState11 = (0,react.useState)(false),
    _useState12 = _slicedToArray(_useState11, 2),
    hiddenNextButton = _useState12[0],
    setHiddenNextButton = _useState12[1];
  var _useState13 = (0,react.useState)(true),
    _useState14 = _slicedToArray(_useState13, 2),
    hiddenReadyButton = _useState14[0],
    setHiddenReadyButton = _useState14[1];
  var _useState15 = (0,react.useState)(true),
    _useState16 = _slicedToArray(_useState15, 2),
    hiddenRestartButton = _useState16[0],
    setHiddenRestartButton = _useState16[1];
  var _useState17 = (0,react.useState)(true),
    _useState18 = _slicedToArray(_useState17, 2),
    hiddenTimer = _useState18[0],
    setHiddenTimer = _useState18[1];
  var _useState19 = (0,react.useState)(false),
    _useState20 = _slicedToArray(_useState19, 2),
    hiddenWord = _useState20[0],
    setHiddenWord = _useState20[1];
  var _useState21 = (0,react.useState)('Paina mieleesi ruudulla näkyvät sanat. Kun aika on loppu, kirjoita sanat ruudulle ilmestyviin laatikoihin. Halutessasi saat vastauslaatikot näyviin heti painamalla sekuntikellon kuvaa.'),
    _useState22 = _slicedToArray(_useState21, 2),
    infoText = _useState22[0],
    setInfoText = _useState22[1];
  var _useState23 = (0,react.useState)(1),
    _useState24 = _slicedToArray(_useState23, 2),
    round = _useState24[0],
    setRound = _useState24[1];
  var _useState25 = (0,react.useState)('Aloita peli'),
    _useState26 = _slicedToArray(_useState25, 2),
    startText = _useState26[0],
    setStartText = _useState26[1];
  var _useState27 = (0,react.useState)(9),
    _useState28 = _slicedToArray(_useState27, 2),
    timer = _useState28[0],
    setTimer = _useState28[1];
  var _useState29 = (0,react.useState)(9),
    _useState30 = _slicedToArray(_useState29, 2),
    timerStart = _useState30[0],
    setTimerStart = _useState30[1];
  var _useState31 = (0,react.useState)(''),
    _useState32 = _slicedToArray(_useState31, 2),
    twitterLink = _useState32[0],
    setTwitterLink = _useState32[1];
  var _useState33 = (0,react.useState)([]),
    _useState34 = _slicedToArray(_useState33, 2),
    words = _useState34[0],
    setWords = _useState34[1];
  var _useState35 = (0,react.useState)(3),
    _useState36 = _slicedToArray(_useState35, 2),
    wordsCount = _useState36[0],
    setWordsCount = _useState36[1];
  (0,react.useEffect)(function () {
    var path_prefix = window.location.href.match('yle.fi') ? 'https://lusi-dataviz.ylestatic.fi/2019_muistitesti/' : './';
    fetch("".concat(path_prefix, "assets/data/2019_muistitesti_data.json")).then(function (response) {
      if (!response.ok) {
        throw Error(response.statusText);
      }
      return response.text();
    }).then(function (body) {
      setDataAll(body.data.data);
      setData(index_default.shuffle(body.data.data));
    });
  }, []);
  var reset = function reset() {
    setData(index_default.shuffle(dataAll));
    setHiddenInfo(true);
    setHiddenInput(true);
  ...
  var placeWords = (0,react.useCallback)(function () {
    var words1 = [];
    if (data.length > 0) {
  ...
  var showWords = function showWords() {
  ...
  var checkWords = function checkWords() {
    var allow_to_continue = true;
    var incorrect_count = 0;
    var values_correct = [];
    index_default.each(document.querySelectorAll('#app-root-2019_muistitesti .inputs'), function (element) {
      values_correct.push(element.attributes['data-correct'].value);
    });
    index_default.each(document.querySelectorAll('#app-root-2019_muistitesti .inputs'), function (element) {
      if (index_default.contains(values_correct, element.value.trim().toLowerCase()) === true) {
        element.className = 'correct';
        element.value = element.value.trim();
        values_correct = index_default.without(values_correct, element.value.trim().toLowerCase());
      } else {
        incorrect_count++;
        allow_to_continue = false;
        element.className = 'incorrect';
        element.value = index_default.first(values_correct);
        values_correct = index_default.without(values_correct, element.value.trim().toLowerCase());
      }
    });
    if (allow_to_continue === true) {
      ...
      setHiddenNextButton(false);
      setHiddenReadyButton(true);
      setInfoText("P\xE4\xE4sit ".concat(round + 1, ". kierrokselle!"));
      setRound(round + 1);
      setStartText('Jatka');
    } else {
      var url = 'https://yle.fi/aihe/artikkeli/2019/08/20/muistipeli-testaa-miten-hyvin-muistisi-toimii';
      setFacebookLink("https://www.facebook.com/sharer/sharer.php?u=".concat(encodeURIComponent("https://share.api.yle.fi/share/muistitesti/taso_".concat(round, ".html?url=").concat(url.replace('https://yle.fi/aihe/', '')))));
      setHiddenInfo(false);
      setHiddenReadyButton(true);
      setHiddenRestartButton(false);
      setInfoText("Harmi, ".concat(incorrect_count, " meni v\xE4\xE4rin ja peli loppui. P\xE4\xE4sit ").concat(round, ". kierrokselle!"));
      setTwitterLink("https://twitter.com/share?url=".concat(url, "&hashtags=").concat(encodeURIComponent('yleoppiminen,yle,muistitesti'), "&text=").concat(encodeURIComponent("P\xE4\xE4sin Ylen Oppimisen muistitestiss\xE4 kierrokselle ".concat(round, "! Kokeile miten hyvin sin\xE4 muistat sanoja."))));
    }
  };
  var shareButton = function shareButton(event) {
    var specs = "top=".concat(window.screen.height / 2 - 420 / 2, ",left=").concat(window.screen.width / 2 - 550 / 2, ",toolbar=0,status=0,width=550,height=420");
    window.open(event.currentTarget.href, 'Jaa', specs);
    event.preventDefault();
  };
  return /*#__PURE__*/react.createElement("div", {
    className: "app"
  }, /*#__PURE__*/react.createElement("h1", null, "Muistipeli"), /*#__PURE__*/react.createElement("div", {
    className: "words_container"
  }, words.map(function (word) {
    return /*#__PURE__*/react.createElement("div", {
      className: "word_container",
      key: word
    }, !hiddenWord && /*#__PURE__*/react.createElement("span", {
      className: "word"
    }, word), !hiddenInput && /*#__PURE__*/react.createElement("input", {
      "data-correct": word,
      type: "text",
      className: "inputs"
    }));
  })), !hiddenInfo && /*#__PURE__*/react.createElement("div", {
    className: "info_container"
  }, infoText), !hiddenNextButton && /*#__PURE__*/react.createElement("button", {
    className: "button",
    onClick: function onClick() {
      return showWords();
    },
    type: "button"
  }, startText), !hiddenReadyButton && /*#__PURE__*/react.createElement("button", {
    className: "button",
    onClick: function onClick() {
      return checkWords();
    },
    type: "button"
  }, "Vastaa"), !hiddenTimer && /*#__PURE__*/react.createElement("button", {
    className: "timer_container",
    onClick: function onClick() {
      return startInput();
    },
    type: "button"
  }, timer), !hiddenRestartButton && /*#__PURE__*/react.createElement("div", {
    className: "result_container"
  }, /*#__PURE__*/react.createElement("div", {
    className: "share_container"
  }, "Jaa tuloksesi", ' ', /*#__PURE__*/react.createElement("a", {
    href: twitterLink,
    target: "_blank",
    onClick: function onClick() {
      return shareButton();
    ...
    rel: "noreferrer"
  }, "Twitteriss\xE4"), ' ', "ja", ' ', /*#__PURE__*/react.createElement("a", {
    href: facebookLink,
    target: "_blank",
    onClick: function onClick() {
      return shareButton();
    ...
    rel: "noreferrer"
  }, "Facebookissa"), "."), /*#__PURE__*/react.createElement("div", null, /*#__PURE__*/react.createElement("button", {
    className: "button",
    onClick: function onClick() {
      return reset();
    },
...
var appName = '2019_muistitesti';
var getContainer = function getContainer() {
  return document.getElementById("app-root-".concat(appName));
};
var startApp = function startApp() {
  ...
  var root = (0,client/* createRoot */.s)(getContainer());
...
var eventHandlers = {
  onMount: function onMount(name, element) {
    ...
    var parameters = services.getParameters() || {}; /*  */
    startApp(parameters);
  }
};
var plusAppMethods = {
...
} else if (false) { var _step$value, key, value, _iterator, _step, searchParameters, parameters; } else {
  console.log('no env');
}
})();
